...
/** Waveform visualization sample count */
export const WAVEFORM_SIZE = 256;

/** Spectrum analyzer bin count */
export const SPECTRUM_BINS = 64;

/** Spectrum decay factor (higher = slower fall) */
export const SPECTRUM_DECAY = 0.92;

/** Spectrum attack factor (lower = more resistance) */
export const SPECTRUM_ATTACK = 0.35;

/** Base frequency for spectrum mapping */
export const SPECTRUM_BASE_FREQ = 32.703;

/** Bins per octave for spectrum */
export const BINS_PER_OCTAVE = 8;

/** Track row height in pixels */
export const ROW_HEIGHT = 36;

/** Buffer rows for virtual scroll */
...
/** Channel names */
export const CHANNEL_NAMES: readonly string[] = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L'];

/** SNDH channel names (3 YM channels + 2 DAC channels) */
export const SNDH_CHANNEL_NAMES: readonly string[] = ['A', 'B', 'C', 'L', 'R'];

/** SNDH channel colors */
export const SNDH_CHANNEL_COLORS: readonly string[] = [
...
/** Amplitude history size for SID visualization */
export const AMPLITUDE_HISTORY_SIZE = 64;

/** Note history size for tracker display */
export const NOTE_HISTORY_SIZE = 32;

/** Note scroll speed for tracker display */
...
export const STORAGE_KEY_AUTHOR_SORT = 'ym2149_author_sort';

...
export function getFingerprint(trackOrPath) {
...
export function calculateFingerprintDistance(fp1, fp2) {
...
export function findSimilarByFingerprint(currentPath, maxResults = 10) {
